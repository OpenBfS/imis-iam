 ...
 */
public class UniqueValidator implements ConstraintValidator<Unique, Object>, EntityManagerAwareValidator {
    ...
    private final Map<String, Method> fieldGetters = new HashMap<>();
    private final Map<String, Method> predicateGetters = new HashMap<>();
